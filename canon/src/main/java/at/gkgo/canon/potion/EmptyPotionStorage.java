 ...
 */
public class EmptyPotionStorage implements InsertionOnlyStorage<FluidVariant> {
    ...
    public EmptyPotionStorage(ContainerItemContext context) {
...
//        newStack.setNbt(resource.getNbt());
    ...
    public String toString() {
        return "EmptyPotionStorage[" + context + "]";
    }
}