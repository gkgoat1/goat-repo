 ...
 */
public class FluidPotionStorage implements ExtractionOnlyStorage<FluidVariant>, SingleSlotStorage<FluidVariant> {
//    private static final FluidVariant CONTAINED_FLUID = FluidVariant.of(Fluids.WATER);
    ...
    @Nullable
    public static FluidPotionStorage find(ContainerItemContext context) {
        return isWaterPotion(context) ? new FluidPotionStorage(context) : null;
    }
    ...
    private FluidPotionStorage(ContainerItemContext context) {
...
//            var fl = ((PotionAsFluid)(Object)PotionUtil.getPotion(context.getItemVariant().getNbt())).canon$asFluid();
    ...
    public String toString() {
        return "FluidPotionStorage[" + context + "]";
    }
}
